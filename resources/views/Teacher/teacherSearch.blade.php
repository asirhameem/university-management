                        ...
                        <div>
                            ...
                            <ul class="pt-1 pb-2 px-3 overflow-y-auto">
                                ...
                                <li class="mt-2">
                                    ...
                                    bg-gray-100 dark:bg-gray-200 rounded-lg mb-4" href="/student-detail/{{$user->uid}}">
                                        ...
                                        <div class="flex justify-between">
                                            ...
                                            <div class="flex">
                                                <img class="h-10 w-10 rounded-full mr-3" src="/uploads/profile-picture/{{$user->dp}}" alt="Issue" />
                                                <span>
