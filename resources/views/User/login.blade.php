...
<body class="h-screen overflow-hidden flex items-center justify-center" style="background: #edf2f7;">
    ...
    <div class="min-h-screen flex flex-col items-center justify-center bg-gray-300">
        ...
        <div class="flex flex-col bg-white shadow-md px-4 sm:px-6 md:px-8 lg:px-10 py-8 rounded-md w-full max-w-md">
            ...
            <a href="{{route('user.facebook')}}" class="relative mt-6 border rounded-md py-2 text-sm text-gray-800 bg-gray-100 hover:bg-gray-200">
                ...
                <span class="ml-20">Login with Facebook</span>
            </a>
            ...
            <div class="flex justify-center items-center mt-6">
                <a href="{{route('user.register')}}"  class="inline-flex items-center font-bold text-blue-500 hover:text-blue-700 text-xs text-center">
                    <span>
                        <svg class="h-6 w-6" fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" stroke="currentColor">
