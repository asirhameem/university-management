...
<html lang="en">
 ...
 <section class="ftco-section ftco-no-pb">
   <div class="col-md-3">
      ...
      <a href="{{route('student.add')}}"  class="list-group-item list-group-item-action"><button class="btn btn-lg btn-success" type="button" id="btnaddcourse"><i class="glyphicon glyphicon-ok-sign"></i> Add Student</button> <br> </a>
</div>
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-md-12 heading-section text-center ftco-animate mb-5">
            <span class="subheading"></span>
            <h2 class="mb-2">Student List </h2>
          </div>
        </div>
      </div>
      <form method="post" action="../admin/student" class="search-location mt-md-5">
          <div class="row justify-content-center">
            <div class="col-lg-10 align-items-end">
            <div class="form-group">
              <div class="active-purple-3 active-purple-4 mb-4">
                <input type="text" class="form-control form-control-sm ml-3 w-75" placeholder="Search Student" name="search" id="search">
