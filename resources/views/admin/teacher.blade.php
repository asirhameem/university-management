...
<html lang="en">
 ...
 <section class="ftco-section ftco-no-pb">
      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-md-12 heading-section text-center ftco-animate mb-5">
            ...
            <h2 class="mb-2">Teacher List </h2>
          </div>
        </div>
      </div>
      <form method="post" action="../admin/Teacher" class="search-location mt-md-5">
          <div class="row justify-content-center">
            <div class="col-lg-10 align-items-end">
            <div class="form-group">
              <div class="active-purple-3 active-purple-4 mb-4">
                <input type="text" class="form-control form-control-sm ml-3 w-75" placeholder="Search Teacher" name="search" id="search">
  ...
  <a href="{{ route('teacher.info', $user->uid) }}" class="list-group-item list-group-item-action"><h4>{{$user->name}}</h4> <br> </a>
 @endforeach
</div>
</div>
